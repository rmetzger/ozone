...
public final class CopyOfMemoryBuffer extends Buffer {
	...
	CopyOfMemoryBuffer(final int bufferSize, final ByteBuffer byteBuffer, final MemoryBufferPoolConnector bufferPoolConnector) {
	...
	private CopyOfMemoryBuffer(final int bufferSize, final ByteBuffer byteBuffer, final MemoryBufferRecycler bufferRecycler) {
	 ...
	 */
	@Override
	public CopyOfMemoryBuffer duplicate() {

		if (this.writeMode.get()) {
			throw new IllegalStateException("Cannot duplicate buffer that is still in write mode");
		}

		final CopyOfMemoryBuffer duplicatedMemoryBuffer = new CopyOfMemoryBuffer(this.byteBuffer.limit(),
