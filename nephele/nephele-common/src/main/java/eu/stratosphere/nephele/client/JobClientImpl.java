...
public class JobClientImpl implements JobClient {
	...
	public static class JobCleanUp extends Thread {
		...
		/**
		 * Stores a reference to the {@link JobClientImpl} object this clean up object has been created for.
		 */
		private final JobClientImpl jobClient;
		 ...
		 */
		public JobCleanUp(final JobClientImpl jobClient) {
	 ...
	 */
	public JobClientImpl(final JobGraph jobGraph) throws IOException {
	 ...
	 *         thrown on error while initializing the RPC connection to the job manager
	 */
	public JobClientImpl(final JobGraph jobGraph, final Configuration configuration) throws IOException {
	 ...
	 *         thrown on error while initializing the RPC connection to the job manager
	 */
	public JobClientImpl(final JobGraph jobGraph, final Configuration configuration,
